...
void Constants::init() {
    SENTIMENT_KEYWORDS[u8"긍정"] = {
        ...
        u8"좋아요", u8"만족", u8"감사", u8"최고", u8"좋은", u8"훌륭", u8"추천", u8"좋았어요",
        u8"좋습니다", u8"최고입니다", u8"감사합니다", u8"만족스럽", u8"좋았습니다", u8"빠릅니다", u8"친절합니다",
        u8"저렴합니다", u8"깔끔합니다", u8"정확합니다", u8"안정적입니다", u8"편합니다",
        u8"세련되었습니다", u8"든든합니다", u8"부드럽습니다"
    };
    ...
    SENTIMENT_KEYWORDS[u8"부정"] = {
        ...
        u8"나쁘", u8"불만", u8"실망", u8"최악", u8"별로", u8"불편", u8"불만족", u8"문제",
        u8"불량", u8"불량품", u8"환불", u8"교환", u8"불만족스럽", u8"실망스럽",
        u8"화가 납니다", u8"늦어요", u8"차갑습니다", u8"파손되었습니다", u8"누락되었습니다",
        u8"느립니다", u8"비싸요", u8"어렵습니다", u8"지연되었습니다", u8"완료되지 않았습니다"
    };
